...
#define OP_PLATFORM_FLAVOR_HUAWEI 4

#ifdef OP_HUAWEI
#define AVALON_PLATFORM_FLAVOR OP_PLATFORM_FLAVOR_HUAWEI
#else
#define AVALON_PLATFORM_FLAVOR AVALON_PLATFORM_FLAVOR_GOOGLE
#endif
...
#error "You have to define AVALON_PLATFORM_FLAVOR first"
    ...
    && (AVALON_PLATFORM_FLAVOR != OP_PLATFORM_FLAVOR_HUAWEI)
...
#define AVALON_PLATFORM_IS_ANDROID_AMAZON \
    (AVALON_PLATFORM_IS_ANDROID && (AVALON_PLATFORM_FLAVOR == AVALON_PLATFORM_FLAVOR_AMAZON))
#define AVALON_PLATFORM_IS_ANDROID_GOOGLE \
    (AVALON_PLATFORM_IS_ANDROID && (AVALON_PLATFORM_FLAVOR == AVALON_PLATFORM_FLAVOR_GOOGLE))
#define AVALON_PLATFORM_IS_ANDROID_SAMSUNG \
    (AVALON_PLATFORM_IS_ANDROID && (AVALON_PLATFORM_FLAVOR == AVALON_PLATFORM_FLAVOR_SAMSUNG))
#define OP_PLATFORM_IS_ANDROID_HUAWEI \
    (AVALON_PLATFORM_IS_ANDROID && (AVALON_PLATFORM_FLAVOR == OP_PLATFORM_FLAVOR_HUAWEI))
