#ifndef OPPopScene_hpp
#define OPPopScene_hpp
...
///         OPPopScene_hpp<cocos2d::TransitionFlipX>::create(1.0f, cocos2d::TransitionScene::Orientation::LEFT_OVER)
///     );
///
...
public:
    ...
    static OPPopScene* create(float t, Args&&... args)
    {
        OPPopScene* pThisScene = new (std::nothrow) OPPopScene();
